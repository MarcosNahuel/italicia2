      ...
      return (
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-hero-pattern bg-cover bg-center">
            <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/80 to-dark-blue/60"></div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                  Domina el Italiano con Aprendizaje Impulsado por <span className="bg-gradient-to-r from-italian-green via-italian-white to-italian-red bg-clip-text text-transparent">IA</span>
                </h1>
                <p className="text-xl md:text-2xl mb-8 text-gray-200">
                  Combina tecnología de vanguardia con experiencias culturales inmersivas para un viaje revolucionario de aprendizaje de idiomas.
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 mt-12">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-300">Tasa de Éxito</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div
                  ref={towerRef}
                  className="w-full h-[500px] bg-[url('https://images.unsplash.com/photo-1516483638261-f4dbaf036963?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1886&q=80')] bg-contain bg-center bg-no-repeat transition-transform duration-300 ease-out"
                ></div>
